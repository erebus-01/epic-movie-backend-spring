...
public class JwtService {
    ...
    public String generatorToken(UserDetails userDetails) {
        ...
        additionalClaims.put("userId", ((User) userDetails).getId());
        additionalClaims.put("emailVerified", ((User) userDetails).isVerification());

        additionalClaims.put("firstname", ((User) userDetails).getFirstname());
        additionalClaims.put("lastname", ((User) userDetails).getLastname());
